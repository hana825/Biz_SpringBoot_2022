package com.na.book.service.impl;

import com.na.book.model.BookVO;
import com.na.book.persistence.BookDao;
import com.na.book.service.BookService;
...
public class BookServiceImplV1 implements BookService {
    ...
    public int insert(BookVO bookVO) {
        ...
        이때 return 하는 값은 몇 개의 데이터가 추가되었는지 알려주는 지표이다.
        하지만, spring-data(JPA) 에서는 save 를 실행한 후 다시 자기 자신(save 를 실행한 데이터)을 return 한다.
        ...
        2. 만약 테이블에 PK 에 해당하는 데이터가 없으면 INSERT 를 수행한다.
        3. 또, 테이블에 PK 에 해당하는 데이터가 있으면 UPDATE 를 수행한다.
         */
