...
// bootDB 라는 DB 에 tbl_users 라는 이름으로 UserVO 를 참조하여 table 이 있다고 가정 또는 강제 생성
...
public class UserVO {
    ...
    // @Column 을 지정하지 않으면 String 형의 경우 문자열(VARCHAR) 255 를 default 로 설정된다.
    @Column(length = 20)
